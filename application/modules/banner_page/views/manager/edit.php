...
<style>
    select.form-control, textarea.form-control{min-height: 34px}
</style>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="linkTo" value="<?= @$resource->linkTo ?>" class="form-control">
                                                        </div>

                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="">Photo (Hình ảnh nên có kích thước: 1900 x 240)</label>
