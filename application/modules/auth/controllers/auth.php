...
class Auth extends MX_Controller {
	...
	public function users(){
		...
		$this->load->vars(array('title' => 'List Users'));

		$this->template->set(array('users' => $data['users']) );
		$this->template->build('auth2/list_users');
	}
	...
	function login()
	{
		...
		else
		{
			...
			$this->_render_page('auth/auth/login', $data);
		}
	}
	...
	function edit_user($id)
	{
		...
		$this->load->vars(array('title' => 'Edit User'));
		$this->template->set('groups', $groups);
		$this->template->set('user', $data['user']);
		$this->template->set('currentGroups', $currentGroups);
		$this->template->set('message', $message);
		$this->template->build('auth/auth/edit_user');
