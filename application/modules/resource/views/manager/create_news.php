...
<div class="container-fluid" id="pcont">
  <div class="fix-nav-tool">
    ...
    <a href="<?=ADMIN_URL?>resource/news/<?=$this->uri->segment(4)?>/?contentType=<?=$this->input->get('contentType')?>" class="btn btn-default"><i class="fa fa-mail-reply"></i> Close</a>
  </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                      ...
                                      <div class="checkbox my-checkbox">
                                        ...
                                        <input type="checkbox" name="show_gallery" value="1" <?php if(@$resource->show_gallery == 1) echo "checked=checked";?> class="icheck"> Show Gallery </label>

                                        <?php if($this->input->get('contentType') == 'news_item') : ?> 
                                          <label class="checkbox-inline"> 
                                          <input type="checkbox" name="is_hot" value="1" <?php if(@$resource->is_hot == 1) echo "checked=checked";?> class="icheck"> is hot news </label>
                                        <?php endif ?>
                                    ...
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <a href="<?=base_url()?>filemanager/dialog.php?type=1&field_id=icon&fldr=icons" class="btn btn-primary iframe-btn"><i class="fa fa-picture-o"></i> Select File</a>
                                          </span>
                                        </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <span class="input-group-btn">
                                          <a href="<?=base_url()?>filemanager/dialog.php?type=1&field_id=image&fldr=images" class="btn btn-primary iframe-btn"><i class="fa fa-picture-o"></i> Select File</a>
                                          </span>
                                        </div>
