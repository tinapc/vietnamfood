...
if(HOST_NAME == 'trungdungmedia.app') {
	define('SOURES_PATH', $_SERVER['DOCUMENT_ROOT'].'/');
	$site_path = 'http://'.HOST_NAME;
} else {
	define('SOURES_PATH', $_SERVER['DOCUMENT_ROOT'].'/');
	$site_path = 'http://'.HOST_NAME;
}
...
$upload_dir = '/sources/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../sources/'; // relative path from filemanager folder to upload folder (with final /)
