...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2016 at 08:10 AM
...
(85, 'Thông tin tuyển dụng tháng 4', 'Job for July', 'tuyen-dung-thang4', 0, 'job', '', '', '', '', 'Mô tả công việc: thiết kế, chỉnh sửa video/hình ảnh, xử lý âm thanh; dựng phim; biên tập hình ảnh các bản tin dự báo thời tiết…', 'blabla', '<p>viec lam thang 4</p>', '<p>Content - Job for July&nbsp;</p>', 'Thông tin tuyển dụng tháng 4', '', '', '', 0, 'http://tamdiem.com.vn/sources/images/tuyendung.jpg', '', 0, 0, 0, 0, 1, 0, 1422441777, 1460399044, 1, 0, 0, NULL, 0),
...
(152, 'Khuyến mãi', 'Promotion', 'khuyen-mai', 0, 'page', '', '', '', '', 'Khuyến mãi', 'Promotion', '<p>Khuyến m&atilde;i</p>', '<p>Promotion</p>', 'Khuyến mãi', 'Promotion', NULL, NULL, 0, 'http://vietnamesefood.app/sources/images/pic-promotion.jpg', '', 0, 0, 0, 0, 0, 0, 1460445846, 1460447750, 1, 0, 0, NULL, 0),
...
(158, 'Tra Atiso loai 1', 'Tra Atiso loai 1', 'tra-atiso-loai-1', 79, 'product_item', '', NULL, '', NULL, 'Tra Atiso loai 1', 'Tra Atiso loai 1', '<p>content vi</p>', '<p>content en</p>', '0', NULL, NULL, NULL, 0, NULL, NULL, 0, 0, 0, 0, 1, 0, 1460494909, 1460563055, 1, 500, 250, 'sdsd', 17),
(159, 'san pham 2', 'product 2', 'san-pham-2', 79, 'product_item', '', NULL, '', NULL, 'san pham 2', 'san pham 2', '<p>san pham 2 - content</p>', '<p>san pham 2 - content en</p>', '0', NULL, NULL, NULL, 0, NULL, NULL, 0, 0, 0, 0, 2, 0, 1460495230, 1460495230, 1, 450, 0, '', 57),
(160, 'san pham 3', 'product 3', 'san-pham-3', 79, 'product_item', '', NULL, '', NULL, 'san pham 3', 'san pham 3', '<p>san pham 3</p>', '<p>san pham 3</p>', '0', NULL, NULL, NULL, 0, NULL, NULL, 0, 0, 0, 0, 2, 0, 1460535508, 1460535508, 1, 45, 12, '545', 17),
(161, 'sad', 'asd', 'sad', 79, 'product_item', '', NULL, '', NULL, 'asd', 'sad', '<p>sdsad</p>', '<p>sadsad</p>', '0', NULL, NULL, NULL, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 1460563327, 1460563327, 1, 345, 123, '', 11);
...
(1, '127.0.0.1', 'administrator', '$2y$08$pasqC.YOwV85ctSecaccpO7oUJzJFK1IBfB2OVC8E0O6P6wCwyNYW', '', 'admin@admin.com', '', NULL, NULL, 'huohhvMrZ45DjmGSgwcpIO', 1268889823, 1460613839, 1, 'Admin', 'istrator', 'ADMIN', '121212121212'),
...
--
ALTER TABLE `resource`
MODIFY `id` bigint(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=162;
--
